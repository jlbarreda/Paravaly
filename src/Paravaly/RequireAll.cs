...
namespace Paravaly
{
	...
	public sealed class RequireAll : IRequire
	{
		...
		{
			return new Parameter<Type>(Invariants.DefaultTypeParameterName, typeof(T), ExceptionHandlingMode.ThrowAll);
		}
		...
		{
			return new Parameter<Type>(name, typeof(T), ExceptionHandlingMode.ThrowAll);
		}
	}
}